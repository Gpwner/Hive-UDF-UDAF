 ...
 *
 */
public final class UDAFCollect extends UDAF {
     ...
     */
    public static class UDAFCollectState {
     ...
     */
    public static class UDAFCollectEvaluator implements UDAFEvaluator {

	UDAFCollectState state;

	public UDAFCollectEvaluator() {
	    super();
	    state = new UDAFCollectState();
	    init();
	}
	 ...
	 */
	public void init() {
	    state.elements = new LinkedList<String>();
	}
	 ...
	 */
	public UDAFCollectState terminatePartial() {
	 ...
	 */
	public boolean merge(UDAFCollectState o) {
	    if (o != null) {
		state.elements.addAll(o.elements);
	    }
	    return true;
	}
